...
data_path = BASE_DIR / "Data" / "BookLib_Merged_DS_for_PPM_3wise24.csv"
print(data_path)
...
joblib.dump(best, models_dir / "BookLib_RT_XGB_binary_3wise24.pkl")
joblib.dump(preproc, models_dir / "BookLib_RT_preproc_binary_3wise24.pkl")

meta = {
    "service_cols": service_cols,
    "num_cols": num_cols,
}
joblib.dump(meta, models_dir / "BookLib_RT_meta_binary_3wise24.pkl")

print("Saved BookLib RT model (binary features) and metadata (3wise24).")
